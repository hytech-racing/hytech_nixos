{
  ...
  outputs = { self, nixpkgs, hytech_data_acq, raspberry-pi-nix, deploy-rs }: rec {
    user_setup = { pkgs, lib, ... }:
      {
    ...
    shared_config = {
      # https://ayats.org/blog/no-flake-utils/ i know that this is a bug of flake utils causing me to put my overlays at a specific system
