            ...
            dt-overlays = {
              mcp2515-can0 = { # can primary
                ...
                params = {
                  ...
                  interrupt = {
                    enable = true;
                    value = "23"; # this is the individual gpio number for the interrupt of the spi boi
                  };
                };
              };
              mcp2515-can1 = {
                ...
                params = {
                  ...
                  interrupt = {
                    enable = true;
                    value = "24"; # this is the individual gpio number for the interrupt of the spi boi
                  };
                };
              };
            };
