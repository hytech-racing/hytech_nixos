            ...
            dt-overlays = {
              mcp2515-can0 = {
                ...
                params = {
                  ...
                  interrupt = {
                    enable = true;
                    value = "0"; # this is the individual gpio number for the interrupt of the spi boi
                  };
                };
              };
              mcp2515-can1 = {
                ...
                params = {
                  ...
                  interrupt = {
                    enable = true;
                    value = "6"; # this is the individual gpio number for the interrupt of the spi boi
                  };
                };
              };
            };
